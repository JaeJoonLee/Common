...
//헤더만 사용해서 작동하게 변경함 2010.10.14 이종희
#ifdef _HEADER_ONLY_TIMER
static __int64 m_Freq; 
static __int64 m_Adjust;
inline int init_timer()
{
	static __int64 m_Freq = 0; 
	static __int64 m_Adjust = 0; 
	return 0;
}

inline int initialize_perftimer()
{
	static int dummy = init_timer();
	return 0;
}
static int dummy = initialize_perftimer();
#endif
