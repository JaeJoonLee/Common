...
void CZipFile::Open(LPCTSTR pathname, bool append)
{
	...
	zi.begin_pos = (DWORD)zi.filezip.GetPosition();
								...
								int method)
{
    ...
    zi.ci.pos_local_header = (DWORD)zi.filezip.GetPosition();
...
void CZipFile::CloseFileInZip()
{
    ...
    long cur_pos_inzip = (long)zi.filezip.GetPosition();
...
void CZipFile::Close(CString global_comment)
{
    ...
    uLong centraldir_pos_inzip = (uLong)zi.filezip.GetPosition();
